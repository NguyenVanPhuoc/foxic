...
@section('content')
	...
	<div id="cat-comics" class="page">
		<div class="head container">
			<h1 class="title">Tin tức - Review</h1>
		</div>	
		<div class="main">
			<a href="{{ route('createArticleAdmin') }}" class="btn btn-primary">Thêm mới</a>
			...
			<form action="#" method="POST" class="dev-form" data-delete="{{ route('deleteAllArticleAdmin') }}">
				{{ csrf_field() }}
