...
@endphp
	<div id="create-cat" class="container route">
		<div class="head">
			...
			<h1 class="title">{{ __('Thêm') }}</h1>
		</div>
		<div class="main">
			<form action="{{ route('storePaymentAdmin') }}" class="dev-form activity-form" method="POST" role="form">
				{{ csrf_field() }}
				<div class="row">
					<div class="col-md-9">
						<div class="form-group">
							<label for="title">{{ __('Tên') }}<small class="required">(*)</small></label>
