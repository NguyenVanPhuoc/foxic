<div class="modal fade right modal-del-comment" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"
  aria-hidden="true">
  <div class="modal-dialog modal-side" role="document">
    ...
    <form action="#" name="deleteChoose" method="POST">
      ...
      <div class="modal-body">{!! __('Các comment kèm theo sẽ bị xoá!</br>Bạn chắc chắn muốn xoá?') !!}</div>
